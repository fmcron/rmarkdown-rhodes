...
```{r lyxeq, fig.cap="LyX code"}
knitr::include_graphics("lyx-eq.png")
```
...
```{r, fig.cap="LyX code "}
knitr::include_graphics("matlyx.png")
```
...
```{r lyxtab, fig.cap="LyX table code"}
knitr::include_graphics("lyxtab.png")
```
...
My LyX table (\@ref(fig:lyxtab2))

```{r lyxtab2, fig.cap="LyX table"}
knitr::include_graphics("lyxtab2.png")
```
...
External figures must be included within an R chunk. As the figure below.


Rhodes symbol (\@ref(fig:rhodes))

```{r rhodes, fig.cap="Rhodes symbol", fig.pos='H', fig.align='center'}
...
`r ''```{r rhodes, fig.cap="Rhodes symbol", fig.pos='H', fig.align='center'}
knitr::include_graphics("rhodes.png")
```
````
